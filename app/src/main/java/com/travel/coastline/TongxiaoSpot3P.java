...
public class TongxiaoSpot3P extends Fragment {
    //顯示文字內容
    private String text = "台灣光復紀念碑";
    private String text2 = "";
    private String text3 = "眺望通霄一望無際的海景";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.tongxiaospot3_1);
        mImg2.setImageResource(R.drawable.tongxiaospot3_2);
        mImg3.setImageResource(R.drawable.tongxiaospot3_3);
