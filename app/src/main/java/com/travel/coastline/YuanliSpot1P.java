...
public class YuanliSpot1P extends Fragment {
    //顯示文字內容
    private String text = "苑裡車站，小火車和紅磚的裝飾";
    private String text2 = "車站前雕塑 ";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.yuanlispot1_1);
        mImg2.setImageResource(R.drawable.yuanlispot1_2);
        mImg3.setImageResource(R.drawable.yuanlispot1_3);
//        mImg4.setImageResource(R.drawable.yuanlispot1_4);
//        mImg5.setImageResource(R.drawable.yuanlispot1_5);
    }
}
