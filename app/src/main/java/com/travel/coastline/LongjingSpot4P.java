...
public class LongjingSpot4P extends Fragment {
    //顯示文字內容
    private String text = "東海藝術街";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longjingspot4_1);
        mImg2.setImageResource(R.drawable.longjingspot4);
        mImg3.setImageResource(R.drawable.longjingspot4_3);
