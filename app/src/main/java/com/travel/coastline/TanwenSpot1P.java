...
public class TanwenSpot1P extends Fragment {
    //顯示文字內容
    private String text = "談文車站、天橋";
    private String text2 = "台1線旁的談文車站";
    private String text3 = "天橋上的景致";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.tanwenspot1_1);
        mImg2.setImageResource(R.drawable.tanwenspot1_2);
        mImg3.setImageResource(R.drawable.tanwenspot1_3);
