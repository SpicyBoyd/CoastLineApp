...
public class LonggangSpot6P extends Fragment {
    //顯示文字內容
    private String text = "海角樂園";
    private String text2 = "裝置藝術";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot6_1);
        mImg2.setImageResource(R.drawable.longgangspot6_2);
        mImg3.setImageResource(R.drawable.longgangspot6_3);
