...
public class DaduSpot1P extends Fragment {
    //顯示文字內容
    private String text = "大肚車站";
    private String text2 = "大肚車站背面";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.daduspot1_1);
        mImg2.setImageResource(R.drawable.daduspot1_2);
        mImg3.setImageResource(R.drawable.daduspot1_3);
