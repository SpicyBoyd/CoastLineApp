...
public class DajiaSpot3P extends Fragment {
    //顯示文字內容
    private String text = "林氏貞孝坊";
    private String text2 = "石碑";
//    private String text3 = "金媽祖";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.dajiaspot3_1);
        mImg2.setImageResource(R.drawable.dajiaspot3_2);
//        mImg3.setImageResource(R.drawable.dajiaspot2_3);
