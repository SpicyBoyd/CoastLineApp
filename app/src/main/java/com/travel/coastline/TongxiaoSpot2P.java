...
public class TongxiaoSpot2P extends Fragment {
    //顯示文字內容
    private String text = "拜殿";
    private String text2 = "石燈籠";
    private String text3 = "社務所";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.tongxiaospot2_1);
        mImg2.setImageResource(R.drawable.tongxiaospot2_2);
        mImg3.setImageResource(R.drawable.tongxiaospot2_3);
