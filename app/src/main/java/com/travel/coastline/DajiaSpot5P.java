...
public class DajiaSpot5P extends Fragment {
    //顯示文字內容
    private String text = "延平郡王像";
    private String text2 = "劍井";
    private String text3 = "忠烈祠";
    private String text4 = "永信公園";
    private String text5 = "星式戰鬥機4178";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.dajiaspot5_1);
        mImg2.setImageResource(R.drawable.dajiaspot5_2);
        mImg3.setImageResource(R.drawable.dajiaspot5_3);
        mImg4.setImageResource(R.drawable.dajiaspot5_4);
        mImg5.setImageResource(R.drawable.dajiaspot5_5);
    }
}
