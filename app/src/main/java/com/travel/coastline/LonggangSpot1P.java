...
public class LonggangSpot1P extends Fragment {
    //顯示文字內容
    private String text = "龍港車站";
    private String text2 = "天橋上，眺望南方";
    private String text3 = "天橋上，眺望西方，後龍溪出海口";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot1_1);
        mImg2.setImageResource(R.drawable.longgangspot1_2);
        mImg3.setImageResource(R.drawable.longgangspot1_3);
