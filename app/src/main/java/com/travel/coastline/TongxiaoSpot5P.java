...
public class TongxiaoSpot5P extends Fragment {
    //顯示文字內容
    private String text = "通霄海水浴場";
    private String text2 = "";
    private String text3 = "長廊";
    private String text4 = "防風林";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.tongxiaospot5_1);
        mImg2.setImageResource(R.drawable.tongxiaospot5_2);
        mImg3.setImageResource(R.drawable.tongxiaospot5_3);
        mImg4.setImageResource(R.drawable.tongxiaospot5_4);
        mImg5.setImageResource(R.drawable.tongxiaospot5_5);
    }
}
