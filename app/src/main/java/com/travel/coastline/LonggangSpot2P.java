...
public class LonggangSpot2P extends Fragment {
    //顯示文字內容
    private String text = "";
    private String text2 = "公司寮漁港";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot2_1);
        mImg2.setImageResource(R.drawable.longgangspot2_2);
        mImg3.setImageResource(R.drawable.longgangspot2_3);
