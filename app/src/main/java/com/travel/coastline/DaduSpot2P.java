...
public class DaduSpot2P extends Fragment {
    //顯示文字內容
    private String text = "磺溪書院";
    private String text2 = "市定三級古蹟";
    private String text3 = "拜殿";
    private String text4 = "花瓶門";
    private String text5 = "連中三元";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.daduspot2_1);
        mImg2.setImageResource(R.drawable.daduspot2_2);
        mImg3.setImageResource(R.drawable.daduspot2_3);
        mImg4.setImageResource(R.drawable.daduspot2_4);
        mImg5.setImageResource(R.drawable.daduspot2_5);
    }
}
