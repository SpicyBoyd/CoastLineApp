...
public class LongjingSpot3P extends Fragment {
    //顯示文字內容
    private String text = "麗水漁港";
    private String text2 = "鄰近火力發電廠";
    private String text3 = "自行車道";
    private String text4 = "大肚溪出海口";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
       ...
       ImageView mImg4 = (ImageView) getActivity().findViewById(R.id.img4);
        ...
        mImg.setImageResource(R.drawable.longjingspot3_1);
        mImg2.setImageResource(R.drawable.longjingspot3_2);
        mImg3.setImageResource(R.drawable.longjingspot3_3);
        mImg4.setImageResource(R.drawable.longjingspot3_4);
        mImg5.setImageResource(R.drawable.longjingspot3_5);
    }
}
