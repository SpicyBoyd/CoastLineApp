...
public class GongtiangongPics extends Fragment {
    //顯示文字內容
    private String text = "拱天宮";
    private String text2 = "拱天宮牌樓";
    private String text3 = "拱天宮供奉的媽祖";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.baishatunspot2);
        mImg2.setImageResource(R.drawable.gongtiangong1);
        mImg3.setImageResource(R.drawable.gongtiangong2);
