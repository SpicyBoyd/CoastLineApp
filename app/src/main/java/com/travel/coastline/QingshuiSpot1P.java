...
public class QingshuiSpot1P extends Fragment {
    //顯示文字內容
    private String text = "清水車站";
    private String text2 = "火車進站";
    private String text3 = "月台";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.qingshuispot1_1);
        mImg2.setImageResource(R.drawable.qingshuispot1_2);
        mImg3.setImageResource(R.drawable.qingshuispot1_3);
