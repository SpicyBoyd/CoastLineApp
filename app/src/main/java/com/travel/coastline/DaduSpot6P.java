...
public class DaduSpot6P extends Fragment {
    //顯示文字內容
//    private String text = "";
...
//        mText5.setText(text5);
        ...
        mImg.setImageResource(R.drawable.daduspot6_1);
        mImg2.setImageResource(R.drawable.daduspot6_2);
        mImg3.setImageResource(R.drawable.daduspot6_3);
        mImg4.setImageResource(R.drawable.daduspot6_4);
        mImg5.setImageResource(R.drawable.daduspot6_5);
    }
}
