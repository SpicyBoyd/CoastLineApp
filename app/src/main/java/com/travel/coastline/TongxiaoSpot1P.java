...
public class TongxiaoSpot1P extends Fragment {
    //顯示文字內容
    private String text = "通霄車站";
    private String text2 = "火車進站";
    private String text3 = "火力發電廠";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.tongxiaospot1_1);
        mImg2.setImageResource(R.drawable.tongxiaospot1_2);
        mImg3.setImageResource(R.drawable.tongxiaospot1_3);
