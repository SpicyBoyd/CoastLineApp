...
public class TaichungPortSpot1P extends Fragment {
    //顯示文字內容
    private String text = "臺中港車站";
    private String text2 = "月台、天橋";
    private String text3 = "天橋上的風景，可說是海線一絕";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.taichungportspot1_1);
        mImg2.setImageResource(R.drawable.taichungportspot1_2);
        mImg3.setImageResource(R.drawable.taichungportspot1_3);
