...
public class LonggangSpot3P extends Fragment {
    //顯示文字內容
    private String text = "文史館";
    private String text2 = "同興老街";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot3_1);
        mImg2.setImageResource(R.drawable.longgangspot3_2);
        mImg3.setImageResource(R.drawable.longgangspot3_3);
