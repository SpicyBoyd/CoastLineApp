...
public class YuanliSpot4P extends Fragment {
    //顯示文字內容
    private String text = "入口";
    private String text2 = "日治宿舍群";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.yuanlispot4_1);
        mImg2.setImageResource(R.drawable.yuanlispot4_2);
        mImg3.setImageResource(R.drawable.yuanlispot4_3);
