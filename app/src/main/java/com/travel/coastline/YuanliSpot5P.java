...
public class YuanliSpot5P extends Fragment {
    //顯示文字內容
    private String text = "稻田彩繪2015";
    private String text2 = "藺草文化館";
    private String text3 = "文物";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.yuanlispot5_1);
        mImg2.setImageResource(R.drawable.yuanlispot5_2);
        mImg3.setImageResource(R.drawable.yuanlispot5_3);
        mImg4.setImageResource(R.drawable.yuanlispot5_4);
        mImg5.setImageResource(R.drawable.yuanlispot5_5);
    }
}
