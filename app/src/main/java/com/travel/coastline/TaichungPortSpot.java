...
public class TaichungPortSpot extends ListActivity {
    ArrayList<HashMap<String,Object>> list=new ArrayList<HashMap<String,Object>>();
    private SimpleAdapter adapter;
    private static final int[] mPics=new int[]{
            R.drawable.taichungportspot1};
    private static final String[] mRatings=new String[]{"★☆☆☆☆"};
    private static final String[] mPlaces=new String[]{"臺中港車站"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(TaichungPortSpot.this,"點擊有興趣的景點",Toast.LENGTH_LONG).show();
        ...
        adapter=new SimpleAdapter(
                this,
                list,
                R.layout.activity_taichung_port_spot,
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.setClass(TaichungPortSpot.this,TaichungPortSpot1.class);
