...
public class DajiaSpot2P extends Fragment {
    //顯示文字內容
    private String text = "大甲鎮瀾宮";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.dajiaspot2_1);
        mImg2.setImageResource(R.drawable.dajiaspot2);
