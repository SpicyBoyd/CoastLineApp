...
public class QingshuiSpot7P extends Fragment {
    //顯示文字內容
    private String text = "趙家古厝";
    private String text2 = "天水堂";
    private String text3 = "荷花";
    private String text4 = "";
    private String text5 = "火車經過";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.qingshuispot7_1);
        mImg2.setImageResource(R.drawable.qingshuispot7_2);
        mImg3.setImageResource(R.drawable.qingshuispot7_3);
        mImg4.setImageResource(R.drawable.qingshuispot7_4);
        mImg5.setImageResource(R.drawable.qingshuispot7_5);
    }
}
