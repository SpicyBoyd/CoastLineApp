...
public class YuanliSpot2P extends Fragment {
    //顯示文字內容
    private String text = "天下路老街";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.yuanlispot2_1);
        mImg2.setImageResource(R.drawable.yuanlispot2_2);
        mImg3.setImageResource(R.drawable.yuanlispot2_3);
