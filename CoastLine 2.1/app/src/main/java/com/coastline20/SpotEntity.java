...
public class SpotEntity {
    ...
    // Tab2
    public SpotEntity(Resources resources, int toolbarImage, int spotName, int spotNum, int[] spotImages, int spotInfo, String address) {
    ...
    // Tab3
    public SpotEntity(Resources resources, int toolbarImage, int spotName, int spotNum, int[] spotImages, int spotInfo, int spotFood, String address) {
        ...
        fragmentList.add(FoodFragment.newInstance(
                resources.getStringArray(spotFood)));
    }
