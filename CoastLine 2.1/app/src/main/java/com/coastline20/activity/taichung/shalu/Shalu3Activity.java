...
public class Shalu3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.shaluspot3,
                R.array.shalu_spot_name,
                3,
                new int[]{R.drawable.shaluspot3_1,
                        R.drawable.shaluspot3_2, R.drawable.shaluspot3_3},
                R.array.shalu3_info,
                "台中市沙鹿區四平街");
