...
public class Yuanli4Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.yuanlispot4,
                R.array.yuanli_spot_name,
                4,
                new int[]{R.drawable.yuanlispot4_1,
                        R.drawable.yuanlispot4_2, R.drawable.yuanlispot4_3},
                R.array.yuanli4_info,
                "苗栗縣苑裡鎮舊社里10鄰47號");
