...
public class Tongxiao1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.tongxiaospot1,
                R.array.tongxiao_spot_name,
                1,
                new int[]{R.drawable.tongxiaospot1_1,
                        R.drawable.tongxiaospot1_2, R.drawable.tongxiaospot1_3},
