...
public class Dadu2Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.daduspot2,
                R.array.dadu_spot_name,
                2,
                new int[]{R.drawable.daduspot2_1,
                        R.drawable.daduspot2_2, R.drawable.daduspot2_3,
                        R.drawable.daduspot2_4, R.drawable.daduspot2_5},
                R.array.dadu2_info,
                "台中市大肚區文昌路60號磺溪書院");
