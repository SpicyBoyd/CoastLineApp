package com.coastline20.activity.taichung.rinan;
...
public class Rinan1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.rinanspot1,
                R.array.rinan_spot_name,
                1,
                new int[]{R.drawable.rinanspot1_1,
                        R.drawable.rinanspot1_2, R.drawable.rinanspot1_3},
                R.array.rinan1_info,
                "臺中市大甲區日南車站");
