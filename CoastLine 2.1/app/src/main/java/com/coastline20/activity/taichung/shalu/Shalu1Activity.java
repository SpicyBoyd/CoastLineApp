package com.coastline20.activity.taichung.shalu;
...
public class Shalu1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.shaluspot1,
                R.array.shalu_spot_name,
                1,
                new int[]{R.drawable.shaluspot1_1,
                        R.drawable.shaluspot1_2, R.drawable.shaluspot1_3},
                R.array.shalu1_info,
                R.array.shalu_food,
                R.array.shalu_food_activity,
                "臺中市沙鹿區中正街94號");
