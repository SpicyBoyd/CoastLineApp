...
public class Dadu6Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.daduspot6,
                R.array.dadu_spot_name,
                6,
                new int[]{R.drawable.daduspot6_1,
                        R.drawable.daduspot6_2, R.drawable.daduspot6_3,
                        R.drawable.daduspot6_4, R.drawable.daduspot6_5},
                R.array.dadu6_info,
                "台中市大肚區大肚山萬里長城");
