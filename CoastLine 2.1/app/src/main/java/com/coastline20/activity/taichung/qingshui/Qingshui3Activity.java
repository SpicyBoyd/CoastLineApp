...
public class Qingshui3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot3,
                R.array.qingshui_spot_name,
                3,
                new int[]{R.drawable.qingshuispot3_1,
                        R.drawable.qingshuispot3_2, R.drawable.qingshuispot3_3,
                        R.drawable.qingshuispot3_4, R.drawable.qingshuispot3_5},
                R.array.qingshui3_info,
                "台中市清水區忠貞路21號港區藝術中心");
