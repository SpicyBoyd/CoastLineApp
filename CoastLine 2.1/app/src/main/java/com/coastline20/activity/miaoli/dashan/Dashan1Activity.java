package com.coastline20.activity.miaoli.dashan;
...
public class Dashan1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.dashanspot1,
                R.array.dashan_spot_name,
                1,
                new int[]{R.drawable.dashanspot1_1,
                        R.drawable.dashanspot1_2, R.drawable.dashanspot1_3},
                R.array.dashan1_info,
                R.array.dashan_spot_address);
