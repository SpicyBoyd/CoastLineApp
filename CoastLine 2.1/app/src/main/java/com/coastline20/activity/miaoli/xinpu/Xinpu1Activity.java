package com.coastline20.activity.miaoli.xinpu;
...
public class Xinpu1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.xinpuspot1,
                R.array.xinpu_spot_name,
                1,
                new int[]{R.drawable.xinpuspot1_1,
                        R.drawable.xinpuspot1_2, R.drawable.xinpuspot1_3},
                R.array.xinpu1_info,
                "苗栗縣通霄鎮新埔車站");
