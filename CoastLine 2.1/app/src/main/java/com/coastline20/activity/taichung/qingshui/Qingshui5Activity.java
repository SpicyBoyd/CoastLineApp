...
public class Qingshui5Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot5,
                R.array.qingshui_spot_name,
                5,
                new int[]{R.drawable.qingshuispot5_1,
                        R.drawable.qingshuispot5_2, R.drawable.qingshuispot5_3,
                        R.drawable.qingshuispot5_4, R.drawable.qingshuispot5_5},
                R.array.qingshui5_info,
                "台中市清水區高南里美堤街八號高美溼地遊客中心");
