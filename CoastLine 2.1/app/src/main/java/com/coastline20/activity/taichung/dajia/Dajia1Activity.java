package com.coastline20.activity.taichung.dajia;
...
public class Dajia1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.dajiaspot1,
                R.array.dajia_spot_name,
                1,
                new int[]{R.drawable.dajiaspot1_1,
                        R.drawable.dajiaspot1_2, R.drawable.dajiaspot1_3},
                R.array.dajia1_info,
                R.array.dajia_food,
