...
public class Qingshui9Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot9,
                R.array.qingshui_spot_name,
                9,
                new int[]{R.drawable.qingshuispot9_1,
                        R.drawable.qingshuispot9_2, R.drawable.qingshuispot9_3},
                R.array.qingshui9_info,
                "台中市清水區清水鬼洞");
