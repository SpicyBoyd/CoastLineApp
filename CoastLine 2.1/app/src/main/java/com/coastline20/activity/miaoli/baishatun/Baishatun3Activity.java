package com.coastline20.activity.miaoli.baishatun;
...
public class Baishatun3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.baishatunspot3,
                R.array.baishatun_spot_name,
                3,
                new int[]{R.drawable.baishatunspot3_1,
