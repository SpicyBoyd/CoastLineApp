package com.coastline20.activity.taichung.dadu;
...
public class Dadu3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.daduspot3,
                R.array.dadu_spot_name,
                3,
                new int[]{R.drawable.daduspot3_1,
                        R.drawable.daduspot3_2, R.drawable.daduspot3_3,
                        R.drawable.daduspot3_4, R.drawable.daduspot3_5},
                R.array.dadu3_info,
                "台中市南屯區中台路望高寮夜景公園");
