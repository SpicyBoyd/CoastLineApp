package com.coastline20.activity.miaoli.tongxiao;
...
public class Tongxiao3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.tongxiaospot3,
                R.array.tongxiao_spot_name,
                3,
                new int[]{R.drawable.tongxiaospot3_1,
                        R.drawable.tongxiaospot3_2, R.drawable.tongxiaospot3_3},
                R.array.tongxiao3_info,
                "24.492791, 120.683474");
