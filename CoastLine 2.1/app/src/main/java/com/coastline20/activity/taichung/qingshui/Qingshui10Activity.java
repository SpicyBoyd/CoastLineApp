...
public class Qingshui10Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                ...
                10,
                new int[]{R.drawable.qingshuispot10_1,
                        R.drawable.qingshuispot10_2, R.drawable.qingshuispot10_3,
                        R.drawable.qingshuispot10_4, R.drawable.qingshuispot10_5},
                R.array.qingshui10_info,
                "台中市清水區鰲海路59號牛罵頭遺址");
