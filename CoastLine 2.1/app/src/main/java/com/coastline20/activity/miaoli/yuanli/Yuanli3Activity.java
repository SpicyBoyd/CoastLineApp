...
public class Yuanli3Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.yuanlispot3,
                R.array.yuanli_spot_name,
                3,
                new int[]{R.drawable.yuanlispot3_1,
                        R.drawable.yuanlispot3_2, R.drawable.yuanlispot3_3,
                        R.drawable.yuanlispot3_4, R.drawable.yuanlispot3_5},
                R.array.yuanli3_info,
                "苗栗縣苑裡鎮房裡老街房里古城");
