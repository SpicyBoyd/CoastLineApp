...
public class Longgang7Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                ...
                7,
                new int[]{R.drawable.longgangspot7_1,
                        R.drawable.longgangspot7_2, R.drawable.longgangspot7_3},
                R.array.longgang7_info,
