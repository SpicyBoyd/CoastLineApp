...
public class Qingshui4Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot4,
                R.array.qingshui_spot_name,
                4,
                new int[]{R.drawable.qingshuispot4_1,
                        R.drawable.qingshuispot4_2, R.drawable.qingshuispot4_3,
                        R.drawable.qingshuispot4_4, R.drawable.qingshuispot4_5},
                R.array.qingshui4_info,
                "台中市清水區鎮政路101號清水眷村文化園區");
