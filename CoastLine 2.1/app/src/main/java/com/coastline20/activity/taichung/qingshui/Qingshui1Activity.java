...
public class Qingshui1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot1,
                R.array.qingshui_spot_name,
                1,
                new int[]{R.drawable.qingshuispot1_1,
                        R.drawable.qingshuispot1_2, R.drawable.qingshuispot1_3},
