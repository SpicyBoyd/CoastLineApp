...
public class Qingshui7Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot7,
                R.array.qingshui_spot_name,
                7,
                new int[]{R.drawable.qingshuispot7_1,
                        R.drawable.qingshuispot7_2, R.drawable.qingshuispot7_3,
                        R.drawable.qingshuispot7_4, R.drawable.qingshuispot7_5},
                R.array.qingshui7_info,
