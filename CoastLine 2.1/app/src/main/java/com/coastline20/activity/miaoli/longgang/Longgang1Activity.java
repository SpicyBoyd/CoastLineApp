package com.coastline20.activity.miaoli.longgang;
...
public class Longgang1Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.longgangspot1,
                R.array.longgang_spot_name,
                1,
                new int[]{R.drawable.longgangspot1_1,
                        R.drawable.longgangspot1_2, R.drawable.longgangspot1_3},
                R.array.longgang1_info,
                "苗栗縣後龍鎮龍港車站");
