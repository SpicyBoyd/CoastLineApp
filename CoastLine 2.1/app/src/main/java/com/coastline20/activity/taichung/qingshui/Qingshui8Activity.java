package com.coastline20.activity.taichung.qingshui;
...
public class Qingshui8Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.qingshuispot8,
                R.array.qingshui_spot_name,
                8,
                new int[]{R.drawable.qingshuispot8_1,
                        R.drawable.qingshuispot8_2, R.drawable.qingshuispot8_3,
                        R.drawable.qingshuispot8_4, R.drawable.qingshuispot8_5},
                R.array.qingshui8_info,
                "台中市清水區大街路觀音巷36-8號鰲峰山市鎮公園");
