package com.coastline20.taichung.longjing;
...
public class Longjing2Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        entity = new SpotEntity(
                getResources(),
                R.drawable.longjingspot2,
                R.array.longjing_spot_name,
                2,
                new int[]{R.drawable.longjingspot2_1,
                        R.drawable.longjingspot2_2},
                R.array.longjing2_info,
                "臺中市龍井區龍目井");
