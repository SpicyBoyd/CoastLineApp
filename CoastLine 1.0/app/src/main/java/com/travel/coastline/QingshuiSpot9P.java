...
public class QingshuiSpot9P extends Fragment {
    //顯示文字內容
    private String text = "清水鬼洞";
    private String text2 = "坑道";
    private String text3 = "戰備用水、廚房";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.qingshuispot9_1);
        mImg2.setImageResource(R.drawable.qingshuispot9_2);
        mImg3.setImageResource(R.drawable.qingshuispot9_3);
//        mImg4.setImageResource(R.drawable.qingshuispot1_4);
//        mImg5.setImageResource(R.drawable.qingshuispot1_5);
    }
}
