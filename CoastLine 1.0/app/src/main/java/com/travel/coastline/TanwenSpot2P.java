...
public class TanwenSpot2P extends Fragment {
    //顯示文字內容
    private String text = "眺望中港溪平原";
    private String text2 = "";
    private String text3 = "鄭漢步道";
    private String text4 = "";
    private String text5 = "鄭漢紀念碑";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.tanwenspot2_1);
        mImg2.setImageResource(R.drawable.tanwenspot2_5);
        mImg3.setImageResource(R.drawable.tanwenspot2_2);
        mImg4.setImageResource(R.drawable.tanwenspot2_3);
        mImg5.setImageResource(R.drawable.tanwenspot2_4);
    }
}
