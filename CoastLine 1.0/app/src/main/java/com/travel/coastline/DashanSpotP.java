...
public class DashanSpotP extends Fragment {
    //顯示文字內容
    private String text = "大山車站";
    private String text2 = "大山車站背面";
    private String text3 = "天橋";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.dashanspot1_1);
        mImg2.setImageResource(R.drawable.dashanspot1_2);
        mImg3.setImageResource(R.drawable.dashanspot1_3);
