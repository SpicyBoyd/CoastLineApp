...
public class LongjingSpot2P extends Fragment {
    //顯示文字內容
    private String text = "龍目井";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longjingspot2_1);
        mImg2.setImageResource(R.drawable.longjingspot2);
        mImg3.setImageResource(R.drawable.longjingspot2_2);
