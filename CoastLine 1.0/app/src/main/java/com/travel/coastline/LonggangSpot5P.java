...
public class LonggangSpot5P extends Fragment {
    //顯示文字內容
    private String text = "過港貝化石層";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot5_1);
        mImg2.setImageResource(R.drawable.longgangspot5_2);
