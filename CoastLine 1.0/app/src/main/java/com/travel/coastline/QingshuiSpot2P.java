...
public class QingshuiSpot2P extends Fragment {
    //顯示文字內容
    private String text = "日式員工宿舍";
    private String text2 = "郵便受";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.qingshuispot2_1);
        mImg2.setImageResource(R.drawable.qingshuispot2);
