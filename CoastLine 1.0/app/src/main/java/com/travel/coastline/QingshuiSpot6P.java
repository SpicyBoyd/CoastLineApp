...
public class QingshuiSpot6P extends Fragment {
    //顯示文字內容
    private String text = "升旗台";
    private String text2 = "仿古鐘樓";
    private String text3 = "";
    private String text4 = "日式宿舍建築群";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.qingshuispot6_1);
        mImg2.setImageResource(R.drawable.qingshuispot6_2);
        mImg3.setImageResource(R.drawable.qingshuispot6_3);
        mImg4.setImageResource(R.drawable.qingshuispot6_4);
        mImg5.setImageResource(R.drawable.qingshuispot6_5);
    }
}
