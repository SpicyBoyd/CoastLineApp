...
public class XinpuSpot1P extends Fragment {
    //顯示文字內容
    private String text = "新埔車站";
    private String text2 = "火車進站";
    private String text3 = "天橋上，向海岸眺望";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.xinpuspot1_1);
        mImg2.setImageResource(R.drawable.xinpuspot1_2);
        mImg3.setImageResource(R.drawable.xinpuspot1_3);
