...
public class DashanSpot extends ListActivity {
    ...
    private static final String[] mPlaces=new String[]{"大山車站"};
...
//            ""};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(DashanSpot.this,"點擊有興趣的景點",Toast.LENGTH_LONG).show();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        super.onListItemClick(l, v, position, id);
            ...
            intent.setClass(DashanSpot.this,DashanSpot1.class);
