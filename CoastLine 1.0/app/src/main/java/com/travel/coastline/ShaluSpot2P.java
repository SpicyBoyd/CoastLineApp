...
public class ShaluSpot2P extends Fragment {
    //顯示文字內容
    private String text = "迦南水果店";
    private String text2 = "新一服裝旗袍";
    private String text3 = "連興商號";
    private String text4 = "糖葫蘆";
    private String text5 = "麵攤";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.shaluspot2_1);
        mImg2.setImageResource(R.drawable.shaluspot2_2);
        mImg3.setImageResource(R.drawable.shaluspot2_3);
        mImg4.setImageResource(R.drawable.shaluspot2_4);
        mImg5.setImageResource(R.drawable.shaluspot2_5);
    }
}
