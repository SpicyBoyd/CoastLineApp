...
public class LongjingSpot1P extends Fragment {
    //顯示文字內容
    private String text = "龍井車站";
    private String text2 = "";
    private String text3 = "龍井車站天橋上，向北眺望";
    private String text4 = "鐵路倉庫";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longjingspot1_1);
        mImg2.setImageResource(R.drawable.longjingspot1_2);
        mImg3.setImageResource(R.drawable.longjingspot1_3);
        mImg4.setImageResource(R.drawable.longjingspot1_4);
