...
public class XinpuSpot2P extends Fragment {
    //顯示文字內容
    private String text = "新埔海邊";
    private String text2 = "涼亭";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.xinpuspot2_1);
        mImg2.setImageResource(R.drawable.xinpuspot2_2);
        mImg3.setImageResource(R.drawable.xinpuspot2_3);
