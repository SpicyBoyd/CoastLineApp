...
public class HoulongSpot1P extends Fragment {
    //顯示文字內容
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.houlongspot1);
        mImg2.setImageResource(R.drawable.houlongspot1_1);
        mImg3.setImageResource(R.drawable.houlongspot1_2);
