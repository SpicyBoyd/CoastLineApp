...
public class BaishatunStationPics extends Fragment {
    //顯示文字內容
    private String text = "白沙屯車站";
    private String text2 = "火車進站";
    private String text3 = "月台和天橋";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.baishatunstation1);
        mImg2.setImageResource(R.drawable.baishatunstation2);
        mImg3.setImageResource(R.drawable.baishatunstation3);
