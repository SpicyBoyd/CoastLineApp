...
public class LonggangSpot7P extends Fragment {
    //顯示文字內容
//    private String text = "";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.longgangspot7_1);
        mImg2.setImageResource(R.drawable.longgangspot7_2);
        mImg3.setImageResource(R.drawable.longgangspot7_3);
