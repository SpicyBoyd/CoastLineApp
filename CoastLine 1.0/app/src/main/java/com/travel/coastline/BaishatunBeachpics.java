...
public class BaishatunBeachpics extends Fragment{
    //顯示文字內容
    private String text = "藍天、白雲、沙灘、大海";
    private String text2 = "沿著海岸線 矗立的風車群";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.baishatunbeach1);
        mImg2.setImageResource(R.drawable.baishatunbeach2);
        mImg3.setImageResource(R.drawable.baishatunbeach3);
