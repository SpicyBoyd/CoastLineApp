...
public class QingshuiSpot5P extends Fragment {
    //顯示文字內容
    private String text = "高美濕地";
    private String text2 = "";
    private String text3 = "木棧道";
    private String text4 = "景觀橋";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.qingshuispot5_1);
        mImg2.setImageResource(R.drawable.qingshuispot5_2);
        mImg3.setImageResource(R.drawable.qingshuispot5_3);
        mImg4.setImageResource(R.drawable.qingshuispot5_4);
        mImg5.setImageResource(R.drawable.qingshuispot5_5);
    }
}
