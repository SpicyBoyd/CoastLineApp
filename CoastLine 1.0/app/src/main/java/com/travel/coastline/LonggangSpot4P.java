...
public class LonggangSpot4P extends Fragment {
    //顯示文字內容
//    private String text = "後龍車站";
//    private String text2 = "月台";
//    private String text3 = "火車進站";
...
//        mText5.setText(text5);
        ...
        mImg.setImageResource(R.drawable.longgangspot4_1);
        mImg2.setImageResource(R.drawable.longgangspot4_2);
        mImg3.setImageResource(R.drawable.longgangspot4_3);
        mImg4.setImageResource(R.drawable.longgangspot4_4);
        mImg5.setImageResource(R.drawable.longgangspot4_5);
    }
}
