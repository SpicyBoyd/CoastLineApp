...
public class QingshuiSpot4P extends Fragment {
    //顯示文字內容
    private String text = "眷村巷弄";
    private String text2 = "寄風冊店";
    private String text3 = "腳踏車 裝置藝術";
    private String text4 = "石頭彩繪";
    private String text5 = "樹群和懷舊國小桌椅";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.qingshuispot4_1);
        mImg2.setImageResource(R.drawable.qingshuispot4_2);
        mImg3.setImageResource(R.drawable.qingshuispot4_3);
        mImg4.setImageResource(R.drawable.qingshuispot4_4);
        mImg5.setImageResource(R.drawable.qingshuispot4_5);
    }
}
