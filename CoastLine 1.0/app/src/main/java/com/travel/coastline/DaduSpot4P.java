...
public class DaduSpot4P extends Fragment {
    //顯示文字內容
    private String text = "步道";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.daduspot4_1);
        mImg2.setImageResource(R.drawable.daduspot4_2);
        mImg3.setImageResource(R.drawable.daduspot4_3);
        mImg4.setImageResource(R.drawable.daduspot4_4);
        mImg5.setImageResource(R.drawable.daduspot4_5);
    }
}
