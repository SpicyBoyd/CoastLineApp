...
public class ShaluSpot1P extends Fragment {
    //顯示文字內容
    private String text = "沙鹿車站";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.shaluspot1_1);
        mImg2.setImageResource(R.drawable.shaluspot1_2);
        mImg3.setImageResource(R.drawable.shaluspot1_3);
