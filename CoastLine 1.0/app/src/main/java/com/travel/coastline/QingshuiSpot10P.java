...
public class QingshuiSpot10P extends Fragment {
    //顯示文字內容
    private String text = "牛罵頭遺址";
    private String text2 = "";
    private String text3 = "";
    private String text4 = "";
    private String text5 = "探坑展示";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mImg.setImageResource(R.drawable.qingshuispot10_1);
        mImg2.setImageResource(R.drawable.qingshuispot10_2);
        mImg3.setImageResource(R.drawable.qingshuispot10_3);
        mImg4.setImageResource(R.drawable.qingshuispot10_4);
        mImg5.setImageResource(R.drawable.qingshuispot10_5);
    }
}
