...
public class RinanSpot2P extends Fragment {
    //顯示文字內容
    private String text = "正式的入口是在中山路上";
    private String text2 = "鹹菜醃桶";
    private String text3 = "做體操";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.rinanspot2_1);
        mImg2.setImageResource(R.drawable.rinanspot2_2);
        mImg3.setImageResource(R.drawable.rinanspot2_3);
