...
public class RinanSpot1P extends Fragment {
    //顯示文字內容
    private String text = "日南車站";
    private String text2 = "日南車站背面";
...
//        ImageView mImg5 = (ImageView) getActivity().findViewById(R.id.img5);
        mImg.setImageResource(R.drawable.rinanspot1_1);
        mImg2.setImageResource(R.drawable.rinanspot1_2);
        mImg3.setImageResource(R.drawable.rinanspot1_3);
